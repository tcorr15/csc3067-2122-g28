...
%% step2
for i=1:5
    %ShowHaarCasade(HaarCasade, i); %comment out to stop spam
end
%% 
...
%% step4
%figure; subplot(1,2,1), imagesc(IntegralImages.ii); subplot(1,2,2), imagesc(IntegralImages.ii2); %comment out to stop spam
%% 
...
%% step7/8
thresholdValue = 0.9;
Objects = simpleNMS(Objects,thresholdValue);
%%
